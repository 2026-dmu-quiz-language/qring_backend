...
-- 1. difficulty_level
-- =============================================
INSERT IGNORE INTO difficulty_level (level_code, level_name, level_desc) VALUES
  (1, '쉬움', '기초 영어 단어 수준'),
  (2, '보통', '문장 완성 수준'),
  (3, '어려움', '문맥 이해 수준');
...
INSERT IGNORE INTO quiz_detail (quiz_id, correct_answer, explanation, quiz_type, content_id, script_id, question, options, difficulty, acceptable_answers) VALUES
...
INSERT INTO achievement_comment (min_rate, max_rate, comment_text)
SELECT * FROM (
            SELECT 0   AS min_rate, 20  AS max_rate, '시작이 반이에요! 차근차근 가봐요' AS comment_text
  UNION ALL SELECT 21,  40,  '꾸준히 진행 중이네요'
  UNION ALL SELECT 41,  60,  '절반을 향해 잘 가고 있어요'
  UNION ALL SELECT 61,  80,  '꽤 많이 익히셨네요!'
  UNION ALL SELECT 81,  99,  '거의 다 왔어요!'
