...
(뜻: 의식을 잃고 넘어지다)',
        NULL,
        3,
        '["collapsed down", "passed out", "fell down", "collapsed", "fainted"]',
...
(뜻: 내 의지대로 움직이지 않다)',
        NULL,
        3,
        '["wouldn''t obey", "won''t obey", "wouldn''t listen", "won''t listen", "wouldn''t respond", "won''t respond"]',
...
VALUES (5, 1, '남자친구가 제 꿈을 예측해요', 0, 5);
